                                    ...
                                    <div class="media pb-3 align-items-center justify-content-between">
                                        ...
                                        <div class="media-body pr-3 ">
                                            <a class="mt-0 mb-1 font-size-15 text-dark"
                                                ...
                                                target="_blank">Groupe: {{ $group->designation }}</a> <span
                                                class="badge badge-dark">{{ $group->nbElements }}/{{ $group->capacity }}</span>
                                        </div>
                                    </div>
                                @endforeach
                            @endif
                                    ...
                                    @foreach ($pendingPaiment as $item)
                                        @if (is_null($item->idGroup))
                                            <div class="media pb-3 align-items-center justify-content-between">
                                                ...
                                                <div class="media-body pr-3 ">
                                                    Facture: {{ $item->description }} <span
                                                        class="badge badge-danger">{{ $item->amount - $item->amountPaid }}
                                                        DH</span>
                                        ...
                                        @else
                                            <div class="media pb-3 align-items-center justify-content-between">
                                                ...
                                                <div class="media-body pr-3 ">
                                                    <a class="mt-0 mb-1 font-size-15 text-dark"
                                                        href="{{ route('groups.profil', ['idGroup' => $item->idGroup]) }}">Facture:
                                                ...
                                                <span class=" font-size-12 d-inline-block">
                                                    <button class="btn btn-outline-success payInvoiceBtn"
                                                        data-bs-toggle="modal" data-bs-target="#invoicePaiment"
