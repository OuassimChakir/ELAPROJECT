                                    ...
                                    @if (isset($factureDepenses))
                                        @foreach ($factureDepenses as $facture)
                                            <tr>
                                                ...
                                                <td>{{Storage::get('config.txt')}}-R.{{ str_pad((string) $facture->idExpensePayment, 4, 0, STR_PAD_LEFT) }}
                                                </td>
                                                <td>
                        ...
                        <div class="row">
                            <div class="col btns">
                                ...
                                <button type="submit" name="deleteAll" class="btn btn-outline-danger"
                                    onclick="return confirm('Voulez-vous supprimer définitivement ces Facture?');">
