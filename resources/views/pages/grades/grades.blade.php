        ...
        <div class="col-xl-12 col-lg-12">
            <div class="ec-cat-list card card-default mb-24px">
                @if (isset($updatedGrade))
                    <div class="card-body" id="formSection" style="display:block;">
                        <div class="ec-cat-form">
                            <h4>Modifier un niveau</h4>
                            <form action="{{ route('grades.update.query', ['idGrade' => $updatedGrade->idGrade]) }}"
                                method="put">
                                @csrf
                                @method('put')
                    ...
                    <div class="card-body">
                        ...
                        <div class="ec-cat-form">
                            <form>
                                <div class="form-group row">
                                    <div class="col-8">
                                        <select id="gradeCategory" name="gradeCategory" class="custom-select"
                                            onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);"
                                            required>
                                            <option selected disabled>-- Choisir la Categorie du Niveau --</option>
                                            @foreach ($gradeCategories as $gradeCategory)
                                                <option
                                                    value="{{ route('grades', ['idGradeCategory' => $gradeCategory->idGradeCategory]) }}">
                                                    {{ $gradeCategory->category }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                        ...
                                        @foreach ($grades as $grade)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a
                                                            href="{{ route('grades.update', ['idGrade' => $grade->idGrade]) }}">
                                                        ...
                                                        <a
                                                            href="{{ route('grades.delete', ['idGrade' => $grade->idGrade]) }}">
                                                            <button type="submit" class="btn btn-outline-danger"
                                                                name="delete" value="{{ $grade->idGrade }}"
