                            ...
                            @foreach ($students as $student)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class="badge badge-danger">{{ $student->pendingPaiment }} <i
                                    ...
                                    <td>
                                        <div class="btn-group-spaced">
                                            <button type="button" class="addNote btn btn-outline-primary"
                                                    value="{{$student->idElement}}">
                                                <i class="bi bi-info"></i>
                                            </button>
                                            <button type="button" class="btn btn-outline-danger"
                                                    onclick="cancelAssignment({{$student->idElement}});">
