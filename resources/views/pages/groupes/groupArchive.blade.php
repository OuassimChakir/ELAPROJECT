    ...
    <div class="breadcrumb-wrapper breadcrumb-contacts">
        <div>
            ...
            <p class="breadcrumbs">
                ...
                <span><i class="mdi mdi-chevron-right"></i></span>Archive des Groupes
            </p>
        </div>
        <div>
            <a>
                <button type="button" class="deleteButton btn btn-outline-danger" data-url="" data-confirm="Une fois supprimé, vous ne pourrez plus récupérer ce groupe !" data-title="Êtes-vous sûr?" data-type="error">
