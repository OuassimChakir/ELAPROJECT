...
@section('content')
    ...
    <div class="breadcrumb-wrapper breadcrumb-contacts">
        ...
        @staff
        <div>
            <button type="button" class="btn btn-info" id="filterSection"><i class="mdi mdi-filter-outline"></i>
            </button>
                                    ...
                                    @foreach ($groupes as $groupe)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <span class="badge badge-danger">{{ $groupe->pendingPaiment }} <i
                                            ...
                                            <td>
                                                ...
                                                @if ($groupe->nbElements == $groupe->capacity)
                                                    <div class="badge badge-pill badge-warning">{{$groupe->nbElements}}
                                                        /{{$groupe->capacity}}</div><br>
                                                @else
                                                    <div class="badge badge-pill badge-success">{{$groupe->nbElements}}
                                                        /{{$groupe->capacity}}</div><br>
                                                @endif
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <button type="button" class="deleteGroup btn btn-outline-danger"
                                                            name="delete" value="{{$groupe->idGroup}}">
