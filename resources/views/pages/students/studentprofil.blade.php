            ...
            <div class="col-lg-8 col-xl-9">
                <div class="profile-content-right profile-right-spacing py-5">
                    <ul class="nav nav-tabs px-3 px-xl-5 nav-style-border" id="myProfileTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="recus-tab" data-bs-toggle="tab" data-bs-target="#recus"
                                type="button" role="tab" aria-controls="recus" aria-selected="false">Reçus</button>
                        </li>
                    ...
                    <div class="tab-content px-3 px-xl-5" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="settings" role="tabpanel" aria-labelledby="settings-tab">
                            <div class="tab-pane-content mt-5">
                                <form action="{{ route('student.update', ['idStudent' => $student->idStudent]) }}"
                                    method="post">
                                    @csrf
                                    @method('put')
                                    <div class="modal-body px-4">
                                        <div class="row mb-2 g-3">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="prenom_fr"
                                                        id="firstName" value="{{ $student->prenom_fr }}" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6" dir="rtl">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control keyboardInput"
                                                        lang="ar" name="prenom_ar" id="firstName_ar"
                                                        value="{{ $student->prenom_ar }}" dir="rtl" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="nom_fr"
                                                        id="lastName" value="{{ $student->nom_fr }}" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6" dir="rtl">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control keyboardInput"
                                                        lang="ar" name="nom_ar" id="lastName_ar" dir="rtl"
                                                        value="{{ $student->nom_ar }}" required>
                                                </div>
                                            </div>
                                            <!-- Email-->
                                            <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-4">
                                                    <label for="numTel">Numéro de Téléphone</label>
                                                    <input type="tel" class="form-control" name="numTel"
                                                        id="numTel" value="{{ $student->sNumTel }}" required>
                                                </div>
                                            </div>
                                            <!-- date Naissance-->
                                            <div class="col-lg-6">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="date" class="form-control" name="dateNaissance"
                                                        id="date" value="{{ $student->dateNaissance }}">
                                                </div>
                                            </div>
                                            <!-- numéro de carte d'identifion-->
                                            <div class="col-lg-6">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="text" class="form-control" name="cnie"
                                                        id="CINE" value="{{ $student->cnie }}" required>
                                                </div>
                                            </div>
                                            <!-- sexe -->
                                            <div class="col-lg-12">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <div class="col-6 d-flex align-items-center justify-content-between">
                                                        @if ($student->sSexe == 'Homme')
                                                            <div class="form-check">
                                                                <input class="form-check-input" value="Homme"
                                                                    type="radio" name="sexe" id="sexe1" checked>
                                                                <label class="form-check-label"
                                                                    for="sexe1">Homme</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" value="Femme"
                                                                    type="radio" name="sexe" id="sexe2">
                                                                <label class="form-check-label"
                                                                    for="sexe2">Femme</label>
                                                            </div>
                                                        @else
                                                    </div>
                                                    <div class="form-check">
                                    ...
                                    <div class="modal-footer px-4">
                                        ...
                                        <button type="submit" name="updateStudent" class="btn btn-warning btn-pill">Mise
                                            à jour</button>
                                    </div>
                                </form>
                            </div>
                        ...
                        {{-- Reçus TAB --}}
                        <div class="tab-pane fade" id="recus" role="tabpanel" aria-labelledby="recus-tab">
                            ...
                            <form action="{{ route('incomePayment.add') }}" method="post">
                                ...
                                <div class="modal-body px-4" id="formSection">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="staffSelect form-group mb-4">
                                                ...
                                                <input type="text" name="matricule" class="form-control"
                                                    value="{{ $student->matricule }}" id="matricule" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-2 g-3">
                                        <div class="col-lg-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="date" name="datePayment" class="form-control"
                                                    id="datePayment">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="number" name="amount" class="form-control"
                                                    id="amount"><small class="text-muted">HD</small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-2 g-3">
                                    ...
                                    <div class="modal-footer px-4">
                                        ...
                                        <button type="submit" name="addPayment"
                                            class="btn btn-primary btn-pill">Ajouter</button>
                                    </div>
                            </form>
                        </div>
