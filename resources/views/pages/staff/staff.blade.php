...
data-bs-target="#addUser"><i class="bi bi-plus-square"></i> Ajouter un Staff
</button>
</div>
</div>
<div class="row">
    ...
    <form action="{{route('staff.delete.multiple')}}" method="post">
        ...
        <table id="responsive-data-table" class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <input type="checkbox" name="staffs[]" value="{{$staff->idStaff}}" class="form-check-input archivedStudents">
                    </td>
                    <td>
                        {{$staff->prenom}}
                        {{$staff->nom}}
                    ...
                    <td>                           
                            <div class="btn-group">
                                <a href="{{route('staff.profil',['idStaff' => $staff->idStaff,'nom' => $staff->nom])}}">
                                    <button type="button" name="edit" class="btn btn-outline-info" value="{{$staff->idStaff}}">
        ...
        <div class="row">
            <div class="col btns">
                <button type="submit" name="deleteAll" class="btn btn-outline-danger" onclick="return confirm('Voulez-vous supprimer définitivement ces Staff?');">
