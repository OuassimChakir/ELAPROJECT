...
<div class="breadcrumb-wrapper breadcrumb-contacts">
    <div>
        ...
        <p class="breadcrumbs"><span><a href="{{route('acceuil')}}">Acceuil</a></span>
            <span><i class="mdi mdi-chevron-right"></i></span><a href="{{route('staff.archive')}}">Archive des Professeurs</a>
        ...
        <div class="col-lg-4 col-xl-3">
            <div class="profile-content-left profile-left-spacing">
                ...
                <div class="contact-info pt-4">
                    ...
                    <p><div class="badge badge-dark">{{$staff->designation}}</div></p>
